...
`scoring/course_standard.py` + `scoring/course_demand.py`. Its course-demand engine is specified in [`docs/methodology/0.1.0/OTRI-MODEL-0.1.0.md`](../docs/methodology/0.1.0/OTRI-MODEL-0.1.0.md) §3, and its retired demo-anchor curve is listed in that page's §14; this README only summarizes it.
