...
The current default is the official Course Standard curved model
(`2.0.0-course-standard`, no competitor dependency). Older scoring curves
remain selectable for historical reproducibility.
"""
