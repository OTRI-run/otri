...
(`docs/methodology/0.1.0/OTRI-MODEL-0.1.0.md` section 14): the 50 m GPX course-demand
...
# Development build V0.1 (retired; docs/methodology/0.1.0/OTRI-MODEL-0.1.0.md section 14).
...
# moves from 692 to 737 as a result. See docs/methodology/0.1.0/OTRI-MODEL-0.1.0.md section 4.
...
# were sitting in the same inflated segment. See docs/methodology/0.1.0/OTRI-MODEL-0.1.0.md section 14.
...
# See docs/methodology/0.1.0/OTRI-MODEL-0.1.0.md section 6.
POWER_EXPONENT = 0.85
POWER_CURVE = replace(
    DEM_GATED_CURVE,
