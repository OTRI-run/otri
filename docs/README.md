...
This directory contains technical, methodology, data, governance, API, and operational documentation.
...
- `operations/` — deployment, maintenance, and operational runbooks
