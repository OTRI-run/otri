...
Research date: 2026-09-17. Status: research specification. The implemented v1 scope and deviations are recorded in the appendix at the end of this page; field-validation targets below remain targets. Audience: the AI or developer implementing course measurement.
...
## Appendix: Course measurement v1: implementation and validation
