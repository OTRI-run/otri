...
- **How a score is computed today?** [`v0.6/OTRI-SMOOTHED-UPPER-CURVE.md`](v0.6/OTRI-SMOOTHED-UPPER-CURVE.md) documents `0.6.0-course-standard-smoothed-upper`, the **current default model**: V0.5's demand and terrain adjustment with V0.1's 692 demo anchor dropped, so one power law runs from 544 to the world-best 1000 anchor and course-level corrections no longer land hardest on the middle of the field.
