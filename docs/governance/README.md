...
| [OEP-004](oep/OEP-004-curve-exponent-0-692.md) | The curve exponent returns to 0.692: OTRI model 0.1.1 | Accepted | build id `0.11.0-course-standard-model-0.1.1` (OTRI model 0.1.1); `0.10.0-course-standard-vertical` kept so that 0.1.0 scores can be reproduced |
