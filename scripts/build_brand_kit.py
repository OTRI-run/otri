...
def main():
    ...
    for suffix,ink,accent in [('',INK,ACCENT),('-white',WHITE,WHITE),('-black',INK,INK),('-on-dark',WHITE,'#dbba89')]:
    ...
    for suffix,bg,ink in [('', '#ebe6da',INK),('-dark',INK,WHITE)]:
        body=f'<rect width="230" height="48" rx="0" fill="{bg}"/><text x="16" y="29" font-size="13" font-family="Arial,sans-serif" fill="{ink}">Scored with</text><g transform="translate(110 10) scale(.56)">{word(ink)}</g>'
