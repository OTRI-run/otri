...
OTRI_API_BASE_URL="${OTRI_API_BASE_URL:-$(keep_env OTRI_API_BASE_URL)}"
...
OTRI_GITHUB_DISPATCH_TOKEN="${OTRI_GITHUB_DISPATCH_TOKEN:-$(keep_env OTRI_GITHUB_DISPATCH_TOKEN)}"
...
OTRI_API_BASE_URL=${OTRI_API_BASE_URL:-https://api.otri.run}
...
OTRI_GITHUB_DISPATCH_TOKEN=${OTRI_GITHUB_DISPATCH_TOKEN}
