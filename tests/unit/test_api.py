...
def test_new_race_defaults_to_course_standard_scoring():
    ...
    assert response.json()["scoring_version"] == "0.4.0-course-standard-endurance-referenced"
...
def test_analyze_gpx_with_finish_time_returns_predicted_score():
    ...
    assert estimate["scoring_version"] == "0.4.0-course-standard-endurance-referenced"
